		              ...
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Event management did exactly what you said it does. I STRONGLY recommend event management to EVERYONE interested in running a successful online business!</p>
		                    <p class="name">Dr. Roronoa Zoro</p>
		                    <span class="position">Rogue</span>
		                  </div>
		                </div>
		              </div>
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Nice work on your event management. You won't regret it. Your company is truly upstanding and is behind its product 100%. Dude, your stuff is the bomb!</p>
		                    <p class="name">Dr. Luffy</p>
		                    <span class="position">pirate</span>
		                  </div>
		                </div>
		              </div>
		            </div>
