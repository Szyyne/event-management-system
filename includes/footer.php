      ...
      <div class="container">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text"> SRM institute of Science and technology
                        Kattankulathur, Chennai, India. </span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 980965435x</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">SRM2k23@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://rrce.org" target="_blank">SRM students</a>
  </p>
          </div>
        </div>
      </div>
